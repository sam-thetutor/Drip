...
import { metaMaskWallet, phantomWallet, subWallet, injectedWallet } from "@rainbow-me/rainbowkit/wallets";
  ...
  [
    {
      ...
      wallets: [metaMaskWallet, phantomWallet, subWallet, injectedWallet],
    },
  ],
  {
