...
import DripV4ABIJson from "./DripV4.abi.json";
...
const DripV4ABI = Array.isArray(DripV4ABIJson)
  ? DripV4ABIJson
  : (DripV4ABIJson as { abi: readonly unknown[] }).abi;
...
export const DRIP_V4_ABI = DripV4ABI as readonly unknown[];

// Re-export for backward compatibility
export { DripCoreABI, SubscriptionManagerABI, DripStakingABI };
